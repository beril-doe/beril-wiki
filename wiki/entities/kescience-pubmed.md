---
type: "Dataset"
description: "KEScience PubMed is a literature-record dataset in the BERDL Data Atlas."
...
**Canonical name:** KEScience PubMed. [src: berdl_data_atlas]

**Known aliases:** No aliases were identified in the source document. [src: berdl_data_atlas]

**Stable external identifier:** No stable external identifier was provided in the source document. [src: berdl_data_atlas]

KEScience PubMed is a literature dataset inventoried in the [[summaries/berdl_data_atlas__REPORT|BERDL Data Atlas]]. [src: berdl_data_atlas]
...
The dataset is part of an inventory spanning 1,740 deduplicated tables across 119 databases and 17 tenants. [src: berdl_data_atlas]

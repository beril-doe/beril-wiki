...
# Does a broad antimicrobial-resistance catalog measure antibiotic resistance or a wider stress-resistance landscape?
...
**Broad catalog: the detected gene set exceeds antibiotic resistance.** The AMRFinderPlus catalog detects metal and stress systems alongside classical antibiotic-resistance determinants, so a catalog-defined antimicrobial-resistance (AMR) count is partly a measure of general stress resistance rather than a narrow antibiotic-resistance count. [src: amr_pangenome_atlas] On this side, the narrow interpretation is weakened by mercury- and arsenic-resistance families among the detected genes and by the 22.2% Other/Unclassified category. [src: amr_pangenome_atlas, amr_environmental_resistome]

**Narrow interpretation: the catalog output read as antibiotic resistance.** Narrow antibiotic-resistance language is applied to the output of the same catalog, and that language and the broad catalog remain in tension in this corpus; no source resolves which reading the downstream claims should carry. [src: amr_pangenome_atlas, amr_environmental_resistome] The two sides also count unassigned genes differently: the environmental-resistome analysis reports 15,550 unassigned clusters (18.7%), not 18,448 (22.2%), and differing denominators and vocabularies must not be silently reconciled — neither figure may be substituted for, averaged with, or corrected against the other. [src: amr_pangenome_atlas, amr_environmental_resistome]

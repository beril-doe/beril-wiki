...
Two projects in this corpus reach opposite conclusions about whether cultured subsurface genomes are biosynthetically self-sufficient — able to make their own building blocks rather than scavenging them from neighbours or the environment. One reads expanded genome content as evidence for self-sufficiency; the other measures amino-acid biosynthesis pathways directly and finds no elevation, and finds lower completeness in the deep cohort once quality filtering is applied. The disagreement matters because it decides what counts as evidence for self-sufficiency at all: the two sides measure different aspects of genomic and metabolic capacity, so a gene-content result and a pathway-completeness result cannot stand in for one another. This tension originates in [[concepts/biosynthetic-self-sufficiency-and-cultivation]].

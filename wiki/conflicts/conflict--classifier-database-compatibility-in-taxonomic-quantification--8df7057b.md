...
Neither side is therefore a refutation of the other: the two results cannot be directly reconciled because they use different responses, different data structures, and different environmental representations [src: ecotype_analysis, euk_in_prok_correlates]. This is a methodological incommensurability claim, not a claim that one result is wrong.

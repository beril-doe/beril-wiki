...
- **Representation hypothesis.** Mapped coverage — the fraction of community abundance linked to the functional-feature construction — could make community-level associations reflect representation rather than biological shifts [src: enigma_contamination_functional_potential].

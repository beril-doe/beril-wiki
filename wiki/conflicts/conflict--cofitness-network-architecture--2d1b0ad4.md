...
Two projects in this corpus agree that fitness signals under different metals look alike, and disagree about what that likeness means. The metal cross-resistance work reports that all tested metal pairs were positive, but it included no negative controls, i.e. no stressor expected *not* to share genes with metals, so universal cross-resistance cannot be distinguished from a general-stress response. [src: metal_cross_resistance] The counter-ion project approached the same question from the opposite direction and concluded the overlap reflects shared cellular stress biology, reporting 4,304/10,821 shared NaCl–metal records (genes important under a metal that are also important under sodium chloride osmotic/ionic stress) and, critically, 44.6% overlap for zinc sulfate despite 0 mM chloride. [src: counter_ion_effects] The stakes are interpretive: this determines whether the cofitness structure described in [[concepts/cofitness-network-architecture]] — the correlation of gene fitness profiles across conditions — is metal-specific wiring or a general-vulnerability backbone visible through any lens.

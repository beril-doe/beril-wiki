...
Two projects in this corpus bear on whether pangenome-level associations survive control for shared ancestry, and they do not meet head-on. One reports an association between prophage marker density — the abundance of integrated-bacteriophage signatures (terminase, phage structural proteins, holin/lysin) in a genome — and antimicrobial resistance (AMR) repertoire breadth that persists across taxa; the other reports a null result for pangenome openness, the degree to which a species keeps acquiring new genes as genomes are added, as a predictor of whether environment or phylogeny dominates gene content. The tension matters because it bears on whether mobile-element density is a lineage-independent driver of resistance repertoires or a correlate of lineages that happen to be both open-pangenomed and mobile-element-rich. This page records the disagreement at the heart of [[concepts/phylogenetic-confounding-of-pangenome-associations]].

## Evidence Sides

**Side A — the prophage association holds across the reported phyla.** Prophage marker density remained associated with AMR repertoire breadth across all five reported major phyla and after controlling for genome count [src: prophage_amr_comobilization; pangenome_openness].

**Side B — openness did not predict environment or phylogeny effect magnitudes.** The openness analysis found that openness did not predict the magnitude of environment or phylogeny effects — the eco-phylo balance, meaning how much of a species' gene content variation tracks habitat versus ancestry [src: prophage_amr_comobilization; pangenome_openness]. This is a null result and stays a null result: no effect was detected, which is not the same as a demonstrated absence of effect.

...
At issue is whether environment-associated differences in AMR (antimicrobial resistance — genes conferring resistance to antibiotics) gene content reflect ecology, or whether they track the taxonomic composition and uneven sampling of the genomes available. One analysis reports significant environmental effects within five of six phyla and 20 of 141 families, which supports an ecological association [src: amr_environmental_resistome]; the same analysis holds that the majority of families were not testable or significant because of limited environmental breadth [src: amr_environmental_resistome], while a within-species follow-up obtained no general statistical demonstration of environmental structuring [src: amr_strain_variation]. The disagreement matters because it decides whether the environment→resistome link in [[concepts/phylogenetic-confounding-of-pangenome-associations]] is a within-lineage effect or an artifact of which lineages were sequenced.
...
- **Hypothesis: the effect is real but scale-dependent.** Ecology may structure resistomes detectably within phyla and less detectably within families and within species, so the stratified result and the case-study observations can both stand [src: amr_environmental_resistome, amr_strain_variation].
...
- Complement AMRFinderPlus with homology- and HMM-based (hidden Markov model profile) searches for uncharacterized resistance determinants: how much of the clinical contrast remains once unrecognized environmental resistance is detectable?

...
Two projects in this corpus report the strength of the association between environmental similarity and genome-wide gene-content similarity at values separated by a large difference in overall correlation values. A partial correlation here is a correlation between two sets of pairwise distances computed with the other distance terms in the same model held constant, and the medians below are taken across species. The original ecotype analysis places its environment median at 0.0025 [src: ecotype_analysis], the reanalysis places its all-species median at 0.081 across 183 species [src: ecotype_env_reanalysis], and the reanalysis's own quotation of the original, 0.003, does not match the original page's number [src: ecotype_env_reanalysis, ecotype_analysis]. The disagreement matters because it determines whether "environment barely matters genome-wide" is a measured result or an artifact of which genomes were included and how they were sampled. It surfaces on [[concepts/confirmatory-exploratory-ecological-association-discordance]], [[concepts/genome-wide-versus-locus-specific-ecological-adaptation]], [[concepts/sampling-depth-and-downsampling-effects]], and [[concepts/study-batch-confounding-of-environmental-associations]].

...
# Complex I dependence on aromatic substrates: a compensation hypothesis, a cross-species null result, and a model that predicts no essentiality
...
- NDH-2 calls from hidden Markov model (HMM, a profile-based sequence search) and synteny evidence replacing text-matched candidates across the same 14 organisms: does the −0.297 versus −0.156 contrast change direction or magnitude?

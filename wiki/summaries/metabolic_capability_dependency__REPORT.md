---
type: Summary
description: Quantifies latent metabolic pathways, pangenome links, and within-species
  ecotypes.
doc_type: short
full_text: ../sources/metabolic_capability_dependency__REPORT.md
title: Metabolic Capability vs Metabolic Dependency
sources:
- id: metabolic_capability_dependency
  resource: ../sources/metabolic_capability_dependency__REPORT.md
...
- [condition-specific-fitness](../concepts/condition-specific-fitness.md) — The 15.8% latent fraction, carbon-versus-amino-acid contrast, threshold sensitivity, and laboratory-condition limitation show that genomic pathway completeness does not by itself establish fitness dependence. [^metabolic_capability_dependency]
- [gene-essentiality](../concepts/gene-essentiality.md) — The active, intermediate, and latent classes are defined using pathway-level mean absolute fitness t-scores and percentages of essential genes. [^metabolic_capability_dependency]
- [metabolic-model-gapfilling](../concepts/metabolic-model-gapfilling.md) — GapMind completeness predictions, SEED-proxy mapping, excluded pathways, and the proposed direct GapMind gene mapping expose how annotation choices affect metabolic capability analysis. [^metabolic_capability_dependency]
- [pangenome-integration](../concepts/pangenome-integration.md) — The positive association between latent capability rate and pangenome openness (ρ = 0.69, p = 0.0004, n = 22 clades) connects fitness-neutral pathways to pangenome dynamics. [^metabolic_capability_dependency]
- [ecotype-environment-gene-content](../concepts/ecotype-environment-gene-content.md) — All 10 target species formed metabolic clusters, with significant environment-cluster associations in *Salmonella enterica* and *Phenylobacterium* sp. [^metabolic_capability_dependency]
- [gene-function-acquisition-depth](../concepts/gene-function-acquisition-depth.md) — The findings distinguish encoded metabolic capability from measured dependency and identify pathway-category-specific functional realization. [^metabolic_capability_dependency]

[^metabolic_capability_dependency]: [metabolic capability dependency](../sources/metabolic_capability_dependency__REPORT.md)

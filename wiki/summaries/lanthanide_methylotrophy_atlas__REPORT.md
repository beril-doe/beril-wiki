---
type: Summary
description: Pangenome atlas of lanthanide-dependent methanol oxidation and its environmental
  distribution
doc_type: short
full_text: ../sources/lanthanide_methylotrophy_atlas__REPORT.md
title: Lanthanide Methylotrophy Atlas — Summary
sources:
- id: lanthanide_methylotrophy_atlas
  resource: ../sources/lanthanide_methylotrophy_atlas__REPORT.md
...
The ncbi_env environmental classification is text-mining-derived and uses hierarchical regex priorities, so broad classes such as host_associated may contain misclassifications. The study also proposes characterizing f__REEB76, examining lanmodulin sequence diversity in 22 Methylobacterium extorquens genomes with 1 copy each, testing lanthanum and cerium chloride with targeted RB-TnSeq, and reporting the 505 eggNOG lanM false-positive pattern upstream. [^lanthanide_methylotrophy_atlas]

## Slots Into

- [pangenome-integration](../concepts/pangenome-integration.md) — The 293,059-genome atlas, GTDB-r214 stratification, and 18.92 : 1 xoxF:mxaF distribution provide cross-genome evidence for integrating functional markers with taxonomy. [^lanthanide_methylotrophy_atlas]
- [environment-embedding-geography](../concepts/environment-embedding-geography.md) — Soil/sediment enrichment, marine enrichment, host-associated depletion, limited AlphaEarth coverage, and proposed embedding analysis connect marker distribution to environmental geography. [^lanthanide_methylotrophy_atlas]
- [gene-function-acquisition-depth](../concepts/gene-function-acquisition-depth.md) — Broad xoxF distribution, lanmodulin clade restriction, PQQ annotation gaps, and eggNOG-versus-Bakta calibration refine how marker annotations should be interpreted as evidence of function. [^lanthanide_methylotrophy_atlas]

[^lanthanide_methylotrophy_atlas]: [lanthanide methylotrophy atlas](../sources/lanthanide_methylotrophy_atlas__REPORT.md)

---
type: "Summary"
description: "Links bacterial gene essentiality to pangenome conservation across 33 organisms."
doc_type: "short"
...
The finding that 44.7% of essential-unmapped genes were hypothetical parallels the observation from Hutchison et al. (2016) that 149 of 473 genes in a designed minimal Mycoplasma genome were essential and had unknown function. [src: conservation_vs_fitness]

The analysis addresses gene-length bias concerns raised for transposon-based essentiality calls by Goodall et al. (2018), uses the genome-wide mutant-fitness data generated by Price et al. (2018), and adds a pangenome-conservation dimension to those fitness measurements. [src: conservation_vs_fitness]

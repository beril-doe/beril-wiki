...
This approach is especially important when [[entities/bacdive]] species-level phenotypes are used to interpret metabolite production by one isolate. BacDive aggregates *P. fluorescens* strains and, under GTDB reclassification, spans a broad clade identified as *Pseudomonas_E fluorescens_E*; consequently, a species-level rate may not represent the phenotype of FW300-N2E3 specifically. [src: fw300_metabolic_consistency] This limitation connects species-level phenotype inference to [[concepts/metadata-resolution-and-within-species-heterogeneity]] and [[concepts/taxonomic-resolution-dependent-functional-inference]].

...
from authors_build import strip_subjective, subjective_hits

# Real sentences from the rev-1 pages (wiki-extra/authors/), which asserted
...
CHARACTERISING = [
    ...
    "Recurring interests include context-dependent gene essentiality and "
    "conditional fitness.",
